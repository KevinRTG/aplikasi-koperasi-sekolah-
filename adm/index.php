...
$swu2_kredit = nosql($rswu2['nilai']);



$swu3_saldo = $swu_debet - $swu2_kredit;
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo xduit3($swu_debet);?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo xduit3($swu2_kredit);?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">TABUNGAN : SALDO</span>
              <span class="info-box-number"><?php echo xduit3($swu3_saldo);?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
      ...
      <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="card">
              ...
              <div class="card-footer border-transparent text-center">
					<a href="u/pinjam.php" class="btn btn-m btn-danger">SELENGKAPNYA</a>
              </div>
            ...
            <div class="card">
              ...
              <div class="card-footer border-transparent text-center">
					<a href="u/lap_angsuran.php" class="btn btn-m btn-danger">SELENGKAPNYA</a>
              </div>
			...
			$limit = 10;
			$limit = 10;
			$sqlcount = "SELECT pelanggan_pinjam.*, m_pelanggan.nama AS pelanggan_nama 
				FROM pelanggan_pinjam 
				LEFT JOIN m_pelanggan ON pelanggan_pinjam.pelanggan_kd = m_pelanggan.kd
				WHERE pelanggan_pinjam.kredit_nominal_belum IS NOT NULL 
				AND pelanggan_pinjam.kredit_nominal_belum > '0' 
				ORDER BY m_pelanggan.jabatan ASC, m_pelanggan.nama ASC";
			...
			<div class="card">
				...
				<div class="table-responsive">
				  <table class="table m-0">
					...
					<?php
						do 
							{
								$warna = ($warna_set == 0) ? $warna01 : $warna02;
								$warna_set = ($warna_set == 0) ? 1 : 0;
			  ...
			  <div class="card-footer border-transparent text-center">
					<a href="u/lap_belum_lunas.php" class="btn btn-m btn-danger">SELENGKAPNYA</a>
			  </div>
        ...
        <div class="col-md-6">
            ...
            <div class="card">
              ...
              <div class="card-footer border-transparent text-center">
					<a href="m/user.php" class="btn btn-m btn-danger">SELENGKAPNYA</a>
              </div>
            ...
            <div class="card">
              ...
              <div class="card-footer border-transparent text-center">
					<a href="u/lap_peringkat.php" class="btn btn-m btn-danger">SELENGKAPNYA</a>
              </div>
