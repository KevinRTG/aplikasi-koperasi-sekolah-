...
do 
	...
	/*
	//update 
	mysqli_query($koneksi, "UPDATE m_pelanggan SET jml_transaksi = '$tku', ".
								"jml_nominal = '$i_nominal' ".
								"WHERE kd = '$i_kd'");
	 * 
	 */
	 ...
	 //update 
	mysqli_query($koneksi, "UPDATE m_pelanggan SET jml_transaksi = '123' ".
								"WHERE kd = '$i_kd'");
	}
...
//view //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//jumlah 
$qx = mysqli_query($koneksi, "SELECT * FROM m_karyawan");
$rowx = mysqli_fetch_assoc($qx);
$e_total_karyawan = mysqli_num_rows($qx);
...
//transaksi 
$qx = mysqli_query($koneksi, "SELECT * FROM pelanggan_beli");
$rowx = mysqli_fetch_assoc($qx);
$e_total_transaksi = mysqli_num_rows($qx);
...
$rowx = mysqli_fetch_assoc($qx);
$e_total_cash = mysqli_num_rows($qx);
...
//transaksi : cash 
$qx = mysqli_query($koneksi, "SELECT SUM(cash_nominal) AS totalnya ".
								"FROM pelanggan_beli ".
								"WHERE jenis_bayar = 'Cash'");
$rowx = mysqli_fetch_assoc($qx);
$e_uang_cash = balikin($rowx['totalnya']);
...
//transaksi : kredit DP 
$qx = mysqli_query($koneksi, "SELECT SUM(kredit_dp_nominal) AS totalnya ".
								"FROM pelanggan_beli ".
								"WHERE jenis_bayar = 'Kredit'");
$rowx = mysqli_fetch_assoc($qx);
...
//jml retur
$qyuk = mysqli_query($koneksi, "SELECT * FROM pelanggan_beli_brg ".
									"WHERE layan_retur = 'true'");
$yuk_retur = mysqli_num_rows($qyuk);
...
//jml service
$qyuk = mysqli_query($koneksi, "SELECT * FROM pelanggan_beli_brg ".
									"WHERE layan_service = 'true'");
$yuk_service = mysqli_num_rows($qyuk);
...
$qyuk = mysqli_query($koneksi, "SELECT * FROM pelanggan_beli_brg ".
									"WHERE layan_service = 'true' ".
									"AND layan_service_proses <> '0000-00-00' ".
									"AND layan_service_selesai = '0000-00-00'");
$yuk_service_proses = mysqli_num_rows($qyuk);
...
$qyuk = mysqli_query($koneksi, "SELECT * FROM pelanggan_beli_brg ".
									...
									"AND layan_service_proses <> '0000-00-00' ".
									"AND layan_service_selesai <> '0000-00-00'");
$yuk_service_selesai = mysqli_num_rows($qyuk);
...
$qyuk = mysqli_query($koneksi, "SELECT SUM(nominal) AS totalnya ".
									"FROM karyawan_setor");
$ryuk = mysqli_fetch_assoc($qyuk);
$yuk_jml_setor = balikin($ryuk['totalnya']);
...
do
	...
	//detail
	$qyuk2 = mysqli_query($koneksi, "SELECT kd FROM pelanggan_beli ".
...
?>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
			...
			<?php
			$limit = 10;
			$sqlcount = "SELECT * FROM pelanggan_beli ".
							"ORDER BY postdate DESC";
                  ...
                  <table class="table m-0">
                    ...
                    <?php
                    	do 
							...
							<td>'.$i_pel_nama.'</td>
							<td align="right">'.xduit2($i_subtotal).'</td>
							<td>'.$i_jbayar.'</td>
					        </tr>';
							}
        ...
        <div class="col-md-6">
			...
			$limit = 10;
			$sqlcount = "SELECT * FROM m_pelanggan ".
							"ORDER BY round(jml_transaksi) DESC";
                  ...
                  <table class="table m-0">
                    ...
                    <?php
                    	do 
							...
							$i_jml = nosql($data['jml_transaksi']);
							$i_nominal = nosql($data['jml_nominal']);
